...
def example_TEBD_gs_tf_ising_finite(L, g):
    ...
    model_params = dict(L=L, J=1., g=g, bc_MPS='finite', conserve='best')
    M = TFIChain(model_params)
    product_state = ["up"] * (M.lat.N_sites//2) + ["down"] + ["up"]*(M.lat.N_sites-M.lat.N_sites//2-1)
...
if __name__ == "__main__":
    ...
    example_TEBD_gs_tf_ising_finite(L=1000, g=1.5)
#      print("=" * 100, '', '', "=" * 100, sep='\n')
